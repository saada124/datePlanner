...
interface StorybookFinalCardProps {
  selection: DateSelection;
  onConfirm: () => void;
  onEdit: () => void;
}

export const StorybookFinalCard: React.FC<StorybookFinalCardProps> = ({
  selection,
  onConfirm,
  onEdit
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="paper-card p-6 sm:p-9 rounded-2xl shadow-paper-lg text-left relative overflow-hidden mb-6 border border-storybook-border">
        ...
        <div className="space-y-3 bg-[#fcf8f2] p-4 rounded-xl border border-storybook-border text-xs sm:text-sm font-sans">
