...
import { StorybookFinalCard } from './components/StorybookFinalCard';
import { StorybookCelebration } from './components/StorybookCelebration';
        ...
        <AnimatePresence mode="wait">
          {chapter === 'PROLOGUE' && (
            <motion.div
              ...
              className="w-full"
            >
              <StoryCover onBegin={() => setChapter('CHAPTER_1_DATE')} />
            </motion.div>
          )}
