        ...
        >
          ...
          >
            ...
            <p className="font-handwriting text-base text-storybook-roseDark mb-4 relative">
              Send our painted date plan to which email? 🎨
            </p>
            ...
            <input
              ...
              autoFocus
              className="w-full bg-[#f2f7fb] border-2 border-storybook-border rounded-xl px-4 py-3 text-sm font-sans text-storybook-ink placeholder-storybook-inkLight focus:outline-none focus:border-storybook-rose transition-all relative"
            />
